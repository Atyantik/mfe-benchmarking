# Bench run — rspack-svelte — 2026-08-27T07:06:56.940Z

**SPEC_VERSION 4** · catalog `c3b6a5fafb68` · commit `6c945ac` *(working tree dirty)*
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 148 | 0.000 | 40 | 0 | 148 | 3.2 | 0 |
| `/faq` | 144 | 0.000 | 8 | 0 | 144 | 4.2 | 1 |
| `/faq/contact` | 144 | 0.000 | 8 | 0 | 144 | 2.1 | 1 |
| `/product` | 172 | 0.000 | 8 | 0 | 172 | 7.9 | 1 |
| `/product/p-0001` | 168 | 0.000 | 8 | 0 | 168 | 2.6 | 1 |
| `/cart` | 124 | 0.008 | 8 | 0 | 124 | 2.1 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1754 | 4 | 6 | 0.846 |
| `/product` | 1193 | 6 | 14 | 1.138 |
| `/product/p-0001` | 1706 | 4 | 8 | 0.795 |
| `/my-account` | 4229 | 1 | 3 | 0.338 |

Sustained heap: **0.03 kB retained per request** (not a trend), measured after a forced collection.
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 7.96 |
| Warm build (cache intact) | 5.17 |
| Bundler cache saving | 35% |
| Incremental (one app) | 0.91 |
| Stack startup | 3.37 |
| **Clean tree to a rendering page** | **11.33** |
| **Edit to browser** | **5.51** |
| Lint | 9.85 |
| Typecheck | 8.68 |
| Test | 5.38 |
...
| product | 1.57 | 0.90 |
| cart | 1.38 | 0.86 |
| storefront | 1.15 | 0.87 |
| my-account | 1.33 | 0.84 |
