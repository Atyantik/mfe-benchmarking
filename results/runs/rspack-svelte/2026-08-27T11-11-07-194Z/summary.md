# Bench run — rspack-svelte — 2026-08-27T11:11:07.194Z

**SPEC_VERSION 4** · catalog `c3b6a5fafb68` · commit `2c02f82` *(working tree dirty)*
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 2652 | 0.000 | 8 | 0 | 1000 | 7.1 | 0 |
| `/faq` | 820 | 0.000 | 40 | 0 | 820 | 7.1 | 0 |
| `/faq/contact` | 828 | 0.000 | 8 | 0 | 828 | 2.7 | 0 |
| `/product` | 1124 | 0.000 | 40 | 0 | 1124 | 7.8 | 0 |
| `/product/p-0001` | 1136 | 0.000 | 8 | 0 | 1136 | 3.0 | 0 |
| `/cart` | 1000 | 0.008 | 40 | 0 | 1000 | 6.8 | 0 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1775 | 4 | 6 | 0.836 |
| `/product` | 1201 | 6 | 14 | 1.114 |
| `/product/p-0001` | 1660 | 4 | 10 | 0.825 |
| `/my-account` | 4383 | 1 | 3 | 0.326 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 8.02 |
| Warm build (cache intact) | 5.61 |
| Bundler cache saving | 30% |
| Incremental (one app) | 0.95 |
| Stack startup | 3.37 |
| **Clean tree to a rendering page** | **11.38** |
| **Edit to browser** | **5.40** |
| Lint | 10.26 |
| Typecheck | 8.45 |
| Test | 5.43 |
...
| product | 1.49 | 0.94 |
| cart | 1.37 | 0.91 |
| storefront | 1.26 | 0.87 |
| my-account | 1.41 | 0.89 |
