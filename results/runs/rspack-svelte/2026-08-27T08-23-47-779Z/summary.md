# Bench run — rspack-svelte — 2026-08-27T08:23:47.779Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 144 | 0.000 | 8 | 0 | 144 | 3.3 | 0 |
| `/faq` | 140 | 0.000 | 8 | 0 | 140 | 3.6 | 1 |
| `/faq/contact` | 140 | 0.000 | 8 | 0 | 140 | 2.3 | 1 |
| `/product` | 168 | 0.000 | 8 | 0 | 168 | 5.5 | 1 |
| `/product/p-0001` | 168 | 0.000 | 8 | 0 | 168 | 4.3 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1778 | 4 | 7 | 0.831 |
| `/product` | 1194 | 6 | 14 | 1.123 |
| `/product/p-0001` | 1873 | 4 | 6 | 0.750 |
| `/my-account` | 4390 | 1 | 3 | 0.325 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 7.95 |
| Warm build (cache intact) | 5.08 |
| Bundler cache saving | 36% |
| Incremental (one app) | 0.91 |
| Stack startup | 3.36 |
| **Clean tree to a rendering page** | **11.31** |
...
| product | 1.57 | 0.84 |
| cart | 1.38 | 0.85 |
| storefront | 1.14 | 0.85 |
| my-account | 1.33 | 0.85 |
