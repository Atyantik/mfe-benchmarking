# Bench run — rspack-svelte — 2026-08-27T08:34:57.237Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 144 | 0.000 | 8 | 0 | 144 | 3.0 | 0 |
| `/faq` | 140 | 0.000 | 8 | 0 | 140 | 2.4 | 1 |
| `/faq/contact` | 140 | 0.000 | 8 | 0 | 140 | 2.3 | 1 |
| `/product` | 164 | 0.000 | 8 | 0 | 164 | 5.3 | 1 |
| `/product/p-0001` | 168 | 0.000 | 8 | 0 | 168 | 4.4 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1749 | 4 | 6 | 0.841 |
| `/product` | 1212 | 6 | 14 | 1.117 |
| `/product/p-0001` | 1873 | 4 | 6 | 0.752 |
| `/my-account` | 4413 | 1 | 3 | 0.325 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 7.80 |
| Warm build (cache intact) | 5.04 |
| Bundler cache saving | 35% |
| Incremental (one app) | 0.91 |
| Stack startup | 3.37 |
| **Clean tree to a rendering page** | **11.17** |
