# Bench run — rspack-svelte — 2026-08-27T07:36:48.737Z
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1769 | 4 | 6 | 0.831 |
| `/product` | 1108 | 6 | 14 | 1.199 |
| `/product/p-0001` | 1871 | 4 | 6 | 0.744 |
| `/my-account` | 4438 | 1 | 2 | 0.323 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 7.68 |
| Warm build (cache intact) | 5.05 |
| Bundler cache saving | 34% |
| Incremental (one app) | 0.91 |
| Stack startup | 3.36 |
| **Clean tree to a rendering page** | **11.04** |
| **Edit to browser** | **5.37** |
| Lint | 10.00 |
| Typecheck | 8.66 |
| Test | 5.61 |
