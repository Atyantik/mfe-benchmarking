# Bench run — rspack-svelte — 2026-08-27T11:25:18.667Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 2644 | 0.000 | 8 | 0 | 996 | 7.2 | 0 |
| `/faq` | 820 | 0.000 | 8 | 0 | 820 | 6.5 | 0 |
| `/faq/contact` | 832 | 0.000 | 8 | 0 | 832 | 2.6 | 0 |
| `/product` | 1120 | 0.000 | 8 | 0 | 1120 | 7.3 | 0 |
| `/product/p-0001` | 1136 | 0.000 | 8 | 0 | 1136 | 3.1 | 0 |
| `/cart` | 992 | 0.008 | 8 | 0 | 992 | 6.5 | 0 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1774 | 4 | 6 | 0.832 |
| `/product` | 1195 | 6 | 14 | 1.140 |
| `/product/p-0001` | 1882 | 4 | 6 | 0.752 |
| `/my-account` | 4398 | 1 | 3 | 0.327 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 7.74 |
| Warm build (cache intact) | 5.09 |
| Bundler cache saving | 34% |
| Incremental (one app) | 0.91 |
| Stack startup | 3.35 |
| **Clean tree to a rendering page** | **11.09** |
