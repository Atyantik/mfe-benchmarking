# Bench run — rspack-svelte — 2026-08-27T07:31:15.216Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 144 | 0.000 | 8 | 0 | 144 | 2.8 | 0 |
| `/faq` | 144 | 0.000 | 40 | 0 | 144 | 5.0 | 1 |
| `/faq/contact` | 144 | 0.000 | 8 | 0 | 144 | 2.4 | 1 |
| `/product` | 168 | 0.000 | 8 | 0 | 168 | 5.1 | 1 |
| `/product/p-0001` | 168 | 0.000 | 8 | 0 | 168 | 4.9 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1781 | 4 | 7 | 0.829 |
| `/product` | 1134 | 6 | 14 | 1.174 |
| `/product/p-0001` | 1852 | 4 | 6 | 0.747 |
| `/my-account` | 4422 | 1 | 3 | 0.325 |
