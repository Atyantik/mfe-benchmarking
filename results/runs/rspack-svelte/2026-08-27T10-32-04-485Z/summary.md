# Bench run — rspack-svelte — 2026-08-27T10:32:04.485Z

**SPEC_VERSION 4** · catalog `c3b6a5fafb68` · commit `1feef07` *(working tree dirty)*
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 2652 | 0.000 | 8 | 0 | 1008 | 7.3 | 0 |
| `/faq` | 832 | 0.000 | 8 | 0 | 832 | 6.8 | 0 |
| `/faq/contact` | 832 | 0.000 | 8 | 0 | 832 | 2.5 | 0 |
| `/product` | 1124 | 0.000 | 8 | 0 | 1124 | 7.3 | 0 |
| `/product/p-0001` | 1140 | 0.000 | 40 | 0 | 1140 | 3.2 | 0 |
| `/cart` | 992 | 0.008 | 8 | 0 | 992 | 6.4 | 0 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1596 | 4 | 9 | 0.906 |
| `/product` | 1135 | 6 | 14 | 1.173 |
| `/product/p-0001` | 1814 | 4 | 7 | 0.772 |
| `/my-account` | 4260 | 1 | 3 | 0.335 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 8.44 |
| Warm build (cache intact) | 5.17 |
| Bundler cache saving | 39% |
| Incremental (one app) | 0.94 |
| Stack startup | 3.41 |
| **Clean tree to a rendering page** | **11.85** |
...
| product | 1.64 | 0.86 |
| cart | 1.40 | 0.88 |
| storefront | 1.16 | 0.86 |
| my-account | 1.36 | 0.86 |
