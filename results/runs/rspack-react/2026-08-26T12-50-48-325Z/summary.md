# Bench run — rspack-react — 2026-08-26T12:50:48.325Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 144 | 0.000 | 8 | 0 | 144 | 3.5 | 0 |
| `/faq` | 144 | 0.000 | 8 | 0 | 144 | 2.4 | 1 |
| `/faq/contact` | 144 | 0.000 | 8 | 0 | 144 | 2.5 | 1 |
| `/product` | 168 | 0.000 | 8 | 0 | 168 | 5.0 | 1 |
| `/product/p-0001` | 172 | 0.000 | 8 | 0 | 172 | 4.8 | 1 |
| `/cart` | 128 | 0.008 | 8 | 0 | 128 | 2.5 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1556 | 5 | 6 | 0.842 |
| `/product` | 1059 | 7 | 10 | 1.186 |
| `/product/p-0001` | 1578 | 5 | 6 | 0.781 |
| `/my-account` | 3545 | 2 | 3 | 0.378 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 15.39 |
| Warm build (cache intact) | 13.89 |
| Bundler cache saving | 10% |
| Incremental (one app) | 2.97 |
| Stack startup | 3.40 |
| **Clean tree to a rendering page** | **18.79** |
| **Edit to browser** | **7.40** |
| Lint | 10.16 |
| Typecheck | 8.62 |
| Test | 5.86 |
...
| product | 3.46 | 2.99 |
| cart | 3.13 | 2.89 |
| storefront | 1.22 | 1.14 |
| my-account | 1.23 | 1.13 |
