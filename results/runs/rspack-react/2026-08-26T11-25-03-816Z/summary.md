# Bench run — rspack-react — 2026-08-26T11:25:03.816Z
...
| `/product` | 164 | 0.000 | 8 | 0 | 164 | 5.3 | 1 |
| `/product/p-0001` | 168 | 0.000 | 8 | 0 | 168 | 4.9 | 1 |
| `/cart` | 124 | 0.008 | 8 | 0 | 124 | 2.3 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1636 | 4 | 6 | 0.833 |
| `/product` | 1126 | 7 | 9 | 1.134 |
| `/product/p-0001` | 1709 | 4 | 5 | 0.759 |
| `/my-account` | 3975 | 1 | 3 | 0.334 |

Sustained heap: **0.07 kB retained per request** (monotonic), measured after a forced collection.
...
| Warm build (cache intact) | 13.45 |
| Bundler cache saving | 7% |
| Incremental (one app) | 2.92 |
| Stack startup | 3.38 |
| **Clean tree to a rendering page** | **17.81** |
| **Edit to browser** | **7.56** |
| Lint | 9.78 |
| Typecheck | 9.02 |
| Test | 5.61 |
...
| product | 3.11 | 2.85 |
| cart | 3.02 | 2.81 |
| storefront | 1.25 | 1.11 |
| my-account | 1.25 | 1.13 |
