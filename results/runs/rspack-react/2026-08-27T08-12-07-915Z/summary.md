# Bench run — rspack-react — 2026-08-27T08:12:07.915Z
...
| `/faq` | 144 | 0.000 | 8 | 0 | 144 | 2.6 | 1 |
| `/faq/contact` | 144 | 0.000 | 8 | 0 | 144 | 2.5 | 1 |
| `/product` | 180 | 0.000 | 8 | 0 | 180 | 9.0 | 1 |
| `/product/p-0001` | 168 | 0.000 | 8 | 0 | 168 | 4.8 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1631 | 4 | 6 | 0.832 |
| `/product` | 1087 | 7 | 10 | 1.145 |
| `/product/p-0001` | 1692 | 4 | 5 | 0.753 |
| `/my-account` | 3985 | 1 | 3 | 0.332 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 15.77 |
| Warm build (cache intact) | 13.24 |
| Bundler cache saving | 16% |
| Incremental (one app) | 2.90 |
| Stack startup | 3.37 |
| **Clean tree to a rendering page** | **19.14** |
...
| product | 3.21 | 2.78 |
| cart | 3.03 | 2.77 |
| storefront | 2.42 | 1.10 |
| my-account | 1.21 | 1.06 |
