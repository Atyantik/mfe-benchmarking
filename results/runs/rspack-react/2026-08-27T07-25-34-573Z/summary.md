# Bench run — rspack-react — 2026-08-27T07:25:34.573Z
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1659 | 4 | 6 | 0.820 |
| `/product` | 1000 | 7 | 19 | 1.237 |
| `/product/p-0001` | 1696 | 4 | 6 | 0.756 |
| `/my-account` | 4039 | 1 | 3 | 0.327 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 14.60 |
| Warm build (cache intact) | 13.47 |
| Bundler cache saving | 8% |
| Incremental (one app) | 2.90 |
| Stack startup | 3.40 |
| **Clean tree to a rendering page** | **18.00** |
...
| product | 3.19 | 2.88 |
| cart | 3.13 | 2.77 |
| storefront | 1.19 | 1.12 |
| my-account | 1.18 | 1.11 |
