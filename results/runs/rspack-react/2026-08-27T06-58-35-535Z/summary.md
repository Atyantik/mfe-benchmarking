# Bench run — rspack-react — 2026-08-27T06:58:35.535Z

**SPEC_VERSION 4** · catalog `c3b6a5fafb68` · commit `6c945ac`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 148 | 0.000 | 8 | 0 | 148 | 3.5 | 0 |
| `/faq` | 144 | 0.000 | 8 | 0 | 144 | 4.3 | 1 |
| `/faq/contact` | 144 | 0.000 | 8 | 0 | 144 | 2.3 | 1 |
| `/product` | 168 | 0.000 | 8 | 0 | 168 | 8.8 | 1 |
| `/product/p-0001` | 168 | 0.000 | 8 | 0 | 168 | 2.7 | 1 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1602 | 4 | 6 | 0.845 |
| `/product` | 1085 | 7 | 9 | 1.150 |
| `/product/p-0001` | 1660 | 4 | 6 | 0.761 |
| `/my-account` | 3901 | 1 | 3 | 0.344 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 14.33 |
| Warm build (cache intact) | 13.38 |
| Bundler cache saving | 7% |
| Incremental (one app) | 2.93 |
| Stack startup | 3.41 |
| **Clean tree to a rendering page** | **17.74** |
| **Edit to browser** | **7.30** |
| Lint | 10.13 |
| Typecheck | 8.18 |
| Test | 5.47 |
...
| product | 3.22 | 2.85 |
| cart | 3.00 | 2.82 |
| storefront | 1.16 | 1.11 |
| my-account | 1.18 | 1.08 |
