# Bench run — rspack-react — 2026-08-27T10:10:00.732Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 2644 | 0.000 | 8 | 0 | 1000 | 7.2 | 0 |
| `/faq` | 820 | 0.000 | 8 | 0 | 820 | 6.8 | 0 |
| `/faq/contact` | 832 | 0.000 | 8 | 0 | 832 | 2.4 | 0 |
| `/product` | 1124 | 0.000 | 8 | 0 | 1124 | 8.0 | 0 |
| `/product/p-0001` | 1020 | 0.000 | 8 | 0 | 1020 | 6.9 | 0 |
| `/cart` | 884 | 0.008 | 8 | 0 | 884 | 6.1 | 0 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1648 | 4 | 6 | 0.814 |
| `/product` | 1114 | 7 | 8 | 1.120 |
| `/product/p-0001` | 1706 | 4 | 5 | 0.745 |
| `/my-account` | 3985 | 1 | 2 | 0.330 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 14.28 |
| Warm build (cache intact) | 13.22 |
| Bundler cache saving | 7% |
| Incremental (one app) | 2.84 |
| Stack startup | 3.37 |
| **Clean tree to a rendering page** | **17.66** |
| **Edit to browser** | **7.18** |
| Lint | 9.97 |
| Typecheck | 8.03 |
| Test | 5.29 |
...
| product | 3.16 | 2.78 |
| cart | 2.97 | 2.73 |
| storefront | 1.15 | 1.06 |
| my-account | 1.17 | 1.06 |
