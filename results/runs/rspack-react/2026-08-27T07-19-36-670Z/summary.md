# Bench run — rspack-react — 2026-08-27T07:19:36.670Z
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1612 | 4 | 6 | 0.840 |
| `/product` | 1119 | 7 | 9 | 1.125 |
| `/product/p-0001` | 1705 | 4 | 5 | 0.755 |
| `/my-account` | 3768 | 2 | 3 | 0.345 |
...
| Bundler cache saving | 9% |
| Incremental (one app) | 2.92 |
| Stack startup | 3.36 |
| **Clean tree to a rendering page** | **17.82** |
