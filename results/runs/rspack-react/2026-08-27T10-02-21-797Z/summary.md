# Bench run — rspack-react — 2026-08-27T10:02:21.797Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 2656 | 0.000 | 8 | 0 | 1000 | 7.5 | 0 |
| `/faq` | 828 | 0.000 | 8 | 0 | 828 | 6.8 | 0 |
| `/faq/contact` | 852 | 0.000 | 8 | 0 | 852 | 2.6 | 0 |
| `/product` | 1120 | 0.000 | 8 | 0 | 1120 | 7.0 | 0 |
| `/product/p-0001` | 1020 | 0.000 | 8 | 0 | 1020 | 7.3 | 0 |
| `/cart` | 888 | 0.008 | 8 | 0 | 888 | 6.0 | 0 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1634 | 4 | 6 | 0.819 |
| `/product` | 1115 | 7 | 9 | 1.123 |
| `/product/p-0001` | 1705 | 4 | 6 | 0.747 |
| `/my-account` | 4019 | 1 | 2 | 0.331 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 14.20 |
| Warm build (cache intact) | 13.18 |
| Bundler cache saving | 7% |
| Incremental (one app) | 2.87 |
| Stack startup | 3.36 |
| **Clean tree to a rendering page** | **17.56** |
| **Edit to browser** | **7.22** |
| Lint | 9.85 |
| Typecheck | 7.94 |
| Test | 5.43 |
