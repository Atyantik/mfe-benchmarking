# Bench run — rspack-react — 2026-08-27T10:56:09.401Z
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `/` | 2656 | 0.000 | 40 | 0 | 1004 | 6.7 | 0 |
| `/faq` | 832 | 0.000 | 8 | 0 | 832 | 7.0 | 0 |
| `/faq/contact` | 832 | 0.000 | 8 | 0 | 832 | 3.5 | 0 |
| `/product` | 1128 | 0.000 | 8 | 0 | 1128 | 7.4 | 0 |
| `/product/p-0001` | 1016 | 0.000 | 8 | 0 | 1016 | 3.2 | 0 |
| `/cart` | 880 | 0.008 | 8 | 0 | 880 | 6.2 | 0 |
...
| --- | ---: | ---: | ---: | ---: |
| `/` | 1631 | 4 | 6 | 0.824 |
| `/product` | 1074 | 7 | 10 | 1.165 |
| `/product/p-0001` | 1660 | 4 | 6 | 0.762 |
| `/my-account` | 3898 | 1 | 3 | 0.337 |
...
|  | seconds |
| --- | ---: |
| Cold build (no dist, no cache) | 14.07 |
| Warm build (cache intact) | 13.17 |
| Bundler cache saving | 6% |
| Incremental (one app) | 2.88 |
| Stack startup | 3.35 |
| **Clean tree to a rendering page** | **17.43** |
