 ...
 * `@mf-eval/contracts/fixtures`, which is a shared singleton. Re-exporting it statically
 * would pull a shared module into the entry and break share-scope initialisation, with an
 * error that points at the output file rather than at this line.
 */
